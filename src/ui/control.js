...
define(function () {
     ...
     *    当鼠标在元素内部移动的时候不会多次触发.
     */
    EVENT._eventFilter.mouseenter = window.attachEvent ? null : function(element,type, listener){
        return {
            type: "mouseover",
            listener: baidu.fn.bind(EVENT._eventFilter._crossElementBoundary, this, listener)
        }
    };
     ...
     *    当鼠标在元素区域内部移动的时候不会触发.
     */
    EVENT._eventFilter.mouseleave = window.attachEvent ? null : function(element,type, listener){
        return {
            type: "mouseout",
            listener: baidu.fn.bind(EVENT._eventFilter._crossElementBoundary, this, listener)
        }
    ...
    !T.array.indexOf && (T.array.indexOf = indexOf);
